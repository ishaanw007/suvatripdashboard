...
const Navdata = () => {
  ...
  const menuItems = [
    ...
    {
      id: "rates",
      label: "Rates & Availibility",
      icon: "ri-file-list-3-line",
      link: "/vendor",
      stateVariables: isRate,
      click: function (e) {
        e.preventDefault();
        setIsRate(!isRate);
        setIscurrentState("Rate");
        updateIconSidebar(e);
      },
      subItems: [
        {
          id: "Calender",
          label: "Calender",
          link: "/vendor/rates-availibility/calender",
          parentId: "rates",
        },
        // {
        //   id: "RatePlan",
    ...
    },
    {
      ...
      click: function (e) {
        e.preventDefault();
        setIscurrentState("Reservations");
      },
    },
    {
      id: "Hotels",
      ...
      subItems: [
        {
          id: "generalinfo",
          label: "General Info",
          link: "/vendor/property/general-info",
          parentId: "property",
        },
        {
          id: "charges",
          label: "VAT/TAX/CHARGES",
          link: "/vendor/property/vat-tax-charges",
          parentId: "property",
        },
        {
          id: "photos",
          label: "Photos",
          link: "/vendor/property/photos",
          parentId: "property",
        },
        {
          id: "ammenities",
          label: "Room amenities",
          link: "/vendor/property/ammenities",
          parentId: "property",
        },
        {
          id: "details",
          label: "Room details",
          link: "/vendor/property/details",
          parentId: "property",
        },
        {
          id: "facilities",
          label: "Facilities & services",
          link: "/vendor/property/facilities",
          parentId: "property",
        },
        {
          id: "policy",
          label: "Policy",
          link: "/vendor/property/policy",
          parentId: "property",
        },
        {
          id: "description",
      ...
      subItems: [
        {
          id: "invoice",
          label: "Invoice",
          link: "/vendor/finance/invoice",
          parentId: "Finance",
        },
        {
          id: "crm",
          label: "Reservation Statement",
          link: "/vendor/finance/reservationstatement",
          parentId: "Finance",
        },
        {
          id: "crm",
