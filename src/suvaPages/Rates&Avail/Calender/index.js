  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <h3 className='d-flex mb-4'>Calender</h3>
          <Row>
            <Col xs={12}>
              <Row>
                <Col xl={12}>
                  <Card className="border-0 shadow-none bg-transparent mb-0">
                    <CardBody className="d-flex justify-content-between">
                      <div id="external-events" className="d-flex">
                        {categories &&
                          categories.map((category) => {
                            console.log(category, 'cccccccccc');
                            return (
                              <div
                                className={`bg-${category.type}-subtle external-event fc-event text-${category.type} ms-2`}
                                key={"cat-" + category.id}
                                draggable
                                onDrag={(event) => {
                    ...
                    <Row className="event-form">
                      <Col xs={12}>
                        <div className="mb-3">
                          ...
                          >
                            <option value="bg-danger-subtle">Due Out</option>
                            <option value="bg-success-subtle">Checked In</option>
                            <option value="bg-info-subtle">Checked Out</option>
                            <option value="bg-warning-subtle">Due In</option>
                          </Input>
